...
public class BoardPanel extends JPanel {
	...
	public BoardPanel(SnakeGame game) {
		...
		Color Verdecito = new Color(113, 156, 71);
		setBackground(Verdecito);
	}
	...
	public void paintComponent(Graphics g) {
		 ...
		 */
		Color negrito = new Color(80, 108, 54);
		g.setColor(negrito);
		...
		if(game.isGameOver() || game.isNewGame() || game.isPaused()) {
			...
			if(game.isNewGame()) {
				...
				smallMessage = "Apreta Enter para Empezar";
			} else if(game.isGameOver()) {
				largeMessage = "Has perdio'!";
				smallMessage = "Apreta Enter para Reiniciar";
			} else if(game.isPaused()) {
				largeMessage = "Pausado";
				smallMessage = "Apreta P para Continuar";
			}
